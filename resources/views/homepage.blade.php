...
@section('content')
        ...
        <!--  END Slider  -->
                      <div class="container text  slidertoptext "><img src="wp-content/uploads/2017/05/Untitled.png" class=" imginslider"  >
		...
		<div class="wpb_column vc_column_container vc_col-sm-12 graybg " ><div class="vc_column-inner "><div class="wpb_wrapper">
<!-- Section About -->
...
<div class="col-md-12 padding-leftright-null text-center grey-background">
		...
		<div class="vc_column-inner vc_custom_1499242244791"><div class="wpb_wrapper">
    <!--  Slider  -->
    ...
    padding: 40px;
    margin: auto;     display: none;"  src="{{ URL::to('/').'/'.$Boats1->Boats_logo  }} " draggable="false">     </div>
...
<div class="container BRANDS "><div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner "><div class="wpb_wrapper">
...
<div class="col-md-12 padding-leftright-null text-center  grey-backgroundDARK ">
		...
		<div class="vc_column-inner vc_custom_1499242244791"><div class="wpb_wrapper revealOnScroll "  data-animation=" fadeInRight   ">
    <!--  Slider  -->
...
</div></div></div><div class="col-md-12 padding-leftright-null text-center grey-backgroundDARK">
